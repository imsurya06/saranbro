...
const HeroSection = () => {
  return (
    <section id="home" className="relative h-[100vh] md:h-[80vh] lg:h-[50vh] w-full bg-black text-white flex items-center justify-center overflow-hidden pt-20 pb-16 md:py-16 lg:py-0">
      {/* Background Robotic Arm Image */}
      <img src="/robot-arm-camera.png" alt="Robotic Arm Background" className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] md:w-[1000px] lg:w-[1200px] opacity-30 z-0 pointer-events-none" />
      <div className="relative z-10 w-full px-4 sm:px-8 md:px-12 lg:px-[200px] grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
        ...
        <img src="/camera-hero.png" alt="Center Camera" className="hidden lg:block absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[300px] md:w-[500px] opacity-50 z-20 pointer-events-none" />
        {/* Left Content */}
        <div className="flex flex-col items-center md:items-start text-center md:text-left space-y-6">
          ...
          <Button className="mt-6 px-6 py-4 sm:px-8 sm:py-6 text-base sm:text-lg md:text-xl bg-white/10 text-white border border-white/20 hover:bg-white/20 rounded-full transition-colors duration-300">
            {/* Applied glass effect styles */}
            Get in Touch
          </Button>
        </div>
        {/* Right Content */}
        <div className="flex flex-col items-center md:items-end text-center md:text-right space-y-6 mt-10 md:mt-0">
          <img src="/urban-solitude-1.png" alt="Sharan playing chess" className="w-56 sm:w-64 md:w-72 h-auto rounded-lg shadow-lg" />
