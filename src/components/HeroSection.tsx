...
const HeroSection = () => {
  return (
    <section id="home" className="relative w-full bg-black text-white flex items-center justify-center overflow-hidden pt-40 pb-16 md:py-16 lg:py-0 md:pb-24 lg:pb-32"> {/* Increased pt-32 to pt-40 */}
      ...
      <div className="relative z-10 w-full px-4 sm:px-8 md:px-12 lg:px-[200px] grid grid-cols-1 gap-8 items-center">
        ...
        <div className="flex flex-col md:flex-row gap-8 md:gap-12 items-center w-full">
          ...
          <div className="flex flex-col items-start text-left space-y-6 md:w-1/2">
            ...
            <p className="text-sm sm:text-base md:text-lg lg:text-xl font-sans font-semibold w-full text-left max-w-xs">
